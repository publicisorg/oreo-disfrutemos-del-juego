...
export const Footer = (props:any) => {
  return (
    <footer className='text-white flex flex-col md:flex-row-reverse py-2 w-full md:gap-2 gap-3 md:mb-4 mb-2 justify-center md:justify-between items-center md:items-end md:px-8'>
      {<div onClick={() => props.setShowShare(true)} className={`${!props.start ? "hidden" : "md:hidden flex"} cursor-pointer flex-row justify-center items-center gap-2 text-[10px] duration-300`}>
        <span>
