  ...
  return (
    <div className="md:flex md:justify-between md:w-full md:absolute md:top-0">
      ...
      <div className="md:mt-10 md:mr-10">
        <div onClick={() => props.setShowShare(true)} className={`hidden md:flex flex-row justify-center items-center gap-2 md:gap-3 text-[12px] md:text-base duration-300 text-white`}>
          <span>
